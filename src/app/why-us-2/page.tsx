        ...
        <div className="space-y-6">
          <div>
            <h2 className="text-2xl sm:text-3xl font-light tracking-wide text-white mb-4">
              Simple ideas are often mishandled.
            </h2>
            <div className="w-32 h-px bg-gradient-to-r from-white/50 to-transparent"></div>
          </div>
          <p className="text-base sm:text-lg text-white/80 max-w-2xl">
            Most companies rush past the fundamentals to chase complexity, missing the power that comes from truly understanding and properly executing simple ideas.
          </p>
        </div>

        {/* How Most Do It vs How We Do It */}
        <div className="grid md:grid-cols-2 gap-8 sm:gap-12">
          {/* How Most Do It */}
          <div className="space-y-4">
            <h3 className="text-lg font-medium text-white/70">How most do it</h3>
            <ul className="space-y-3 text-sm text-white/60">
              <li className="flex items-start gap-2">
                <span className="text-white/40 mt-1">•</span>
                <span>Rush to implement without understanding</span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-white/40 mt-1">•</span>
                <span>Overcomplicate with elaborate frameworks</span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-white/40 mt-1">•</span>
                <span>Focus on process over clear thinking</span>
              </li>
            </ul>
          </div>
          ...
          {/* How We Do It */}
          <div className="space-y-4">
            <h3 className="text-lg font-medium text-white">How we do it</h3>
            <div className="space-y-3">
              <div className="flex items-start gap-3">
                <span className={`${theme.typography.fontSize.xs} ${theme.typography.fontWeight.normal} font-mono ${theme.typography.letterSpacing.tight} text-white/50 flex-shrink-0 mt-0.5`}>
                  01
                </span>
                <p className="text-sm text-white/80">Take simple ideas seriously</p>
              </div>
              <div className="flex items-start gap-3">
                <span className={`${theme.typography.fontSize.xs} ${theme.typography.fontWeight.normal} font-mono ${theme.typography.letterSpacing.tight} text-white/50 flex-shrink-0 mt-0.5`}>
                  02
                </span>
                <p className="text-sm text-white/80">Apply clear thinking consistently</p>
              </div>
              <div className="flex items-start gap-3">
                <span className={`${theme.typography.fontSize.xs} ${theme.typography.fontWeight.normal} font-mono ${theme.typography.letterSpacing.tight} text-white/50 flex-shrink-0 mt-0.5`}>
                  03
                </span>
                <p className="text-sm text-white/80">Execute properly, nothing more</p>
              </div>
            </div>
          </div>
        </div>
            ...
            <div className="flex items-start gap-3 sm:gap-6">
              ...
              <div className="flex-1 relative">
                ...
                <div className="mt-4 max-w-2xl space-y-3">
                  <p className="text-base leading-relaxed text-white/80">
                    Our approach is somewhat unconventional. Most teams present elaborate processes and proprietary frameworks.
                  </p>
                  <p className="text-base leading-relaxed text-white/80">
                    We believe the best process is no process at all—just clear thinking applied consistently.
                  </p>
                </div>
              </div>
            </div>
