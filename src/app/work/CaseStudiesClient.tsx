...
export default function CaseStudiesClient() {
  ...
  const caseStudies: CaseStudy[] = [
    ...
    },
    {
      ...
      description: "A comprehensive brand identity and digital presence for a premier general contractor, built from the ground up—website, internal systems, marketing collateral, and brand development.",
      href: "/work/zachary-construction-group",
    ...
    },
    {
      ...
      description: "A compassionate digital platform for pet memorial services, designed to help grieving families honor their beloved pets with dignity and care.",
    ...
    },
    {
      ...
      description: "A professional financial advisory platform designed to convey trust and credibility, making complex wealth management feel transparent and accessible.",
    ...
    {
      title: "Pacific Life",
      description: "Presentation design for Pacific Life's insurance division—transforming complex insurance concepts into digestible, sophisticated visual narratives.",
      href: "/work/pacific-life",
    ...
    },
    {
      ...
      description: "A comprehensive branding and advertising campaign for EY's prestigious global awards program celebrating entrepreneurial excellence.",
      href: "/work/weoy",
    ...
    },
    {
      ...
      description: "Expert insurance advisors providing comprehensive risk management across North America. A modular platform serving diverse industries with brand cohesion.",
      href: "/work/zachary-group",
    ...
    },
    {
      ...
      description: "A digital experience for a Warner Bros. Music Group artist's album release—immersive, cinematic, and genre-bending interactive design.",
